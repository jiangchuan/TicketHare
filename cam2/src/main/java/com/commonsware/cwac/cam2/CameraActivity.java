...
public class CameraActivity extends AbstractCameraActivity
    ...
    public static final String SHOW_CENTER_FOCUS = "cwac_cam2_show_center_focus";
    public static final String HINT_TEXT = "cwac_cam2_hint_text";
    ...
    protected CameraFragment buildFragment() {
        return (CameraFragment.newPictureInstance(getOutputUri(),
                ...
                getIntent().getStringExtra(HINT_TEXT),
                getIntent().getIntExtra(SHOW_CENTER_FOCUS, 0))
        );
    }
    ...
    public static class IntentBuilder
        ...
        public IntentBuilder hintText(String s) {
            result.putExtra(HINT_TEXT, s);
            return (this);
        }

        public IntentBuilder showFocus(int focusMode) {
            result.putExtra(SHOW_CENTER_FOCUS, focusMode);
            return (this);
        }
